...
Open your invitation email and sign in with the invited email address to join your team.

An invitation is tied to the address that received it. GitHub matches the account's primary email. Open the link before it expires, choose GitHub or Google, and make sure the signed-in account has the invited address.
