...
1. Choose **Install GitHub App**. If it is not shown, choose **Authorize GitHub App**. If the app is already installed, choose **Connect your account**.
...
4. Choose the branch that contains the files you want to read.
...
2. Review the file and size limits in [Limits](../reference/limits.md#files), then choose **Create project**.
