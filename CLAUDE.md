...
lib/
  ...
  shell/nav.ts          사이드바의 순수 판정 **셋** — activeProject(pathname의 slug를 **내 멤버십 안에서** 찾는다,
                        ...
                        그대로 들어 권한표가 두 벌이 되지 않는다. ⚠️ **Locales·Home·Logs 항목은 자기 라우트와
