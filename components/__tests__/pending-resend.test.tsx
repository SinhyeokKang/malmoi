...
describe("Resend — 실패는 카드 안 Alert 하나", () => {
  it.each([
    ...
    [{ ok: false, error: "rate-limited", retryAt: "2026-09-23T12:00:30Z", limit: "project", used: 20 }, () => m.members.pending.resendProjectLimited("a***@acme.com", "2026-09-23 12:01 UTC")],
    [{ ok: false, error: "email-unavailable" }, () => m.members.pending.resendUnavailable("a***@acme.com")],
    [{ ok: false, error: "not-found" }, () => m.members.pending.resendGone("a***@acme.com")],
