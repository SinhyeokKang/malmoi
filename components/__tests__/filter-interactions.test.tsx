  ...
  function Harness() {
    ...
    return <Suspense fallback={<p>Loading</p>}>
      ...
      <TranslationsHeader surfaceSlug="default" surfaces={[]} slug="demo" totalCount={2} query={query} chipQuery={query}
        ...
        unpublished={0} repo={{ owner: "owner", name: "repo", branch: "main", syncBranch: "malmoi-i18n/sync-demo" }} role="OWNER" lastSentLabel={null} lastPrUrl={null} baseLocale="en" declaredBaseLocale="en">
        <p>Translations</p>
      </TranslationsHeader>
    </Suspense>;
  }
