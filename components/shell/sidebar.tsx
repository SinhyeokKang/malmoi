 ...
 * 사라졌고, **레일에서만 렌더되던 `Tooltip`도 없어졌다** — 2026-09-08에 셸을 죽였던 그 자리다
 * (프리미티브가 자기 provider를 드는 규칙은 그대로 유효하고 `tooltip-provider.test.ts`가 지킨다).
 *
...
export function Sidebar({
  ...
  return (
    ...
    >
      {/*
        **구역 둘** (SAAS §7.7). ⚠️ **라벨이 이름 그대로다** — 사용자 축은 사용자 이름, 프로젝트 축은
