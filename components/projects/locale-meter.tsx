...
/**
 * 목록 행의 **로케일 Meter** (projects-list design §11.3). 시안 `1c`의 Meter 블록이 정본이고,
    ...
    <div className="flex w-25 flex-col gap-1.5">
      <span className="flex items-center gap-1.5 text-xs">
        {/*
          ...
          새 매핑도, `rounded-[2px]`도 만들지 않는다 (design §11.35).
      ...
      {/*
        ...
        ⚠️ **`aria-hidden`이 아니다** — 라벨 줄의 코드와 퍼센트가 같은 사실을 글자로 말하므로
        스크린리더에 중복이 되지 않게 바만 장식으로 둔다. 완료율·검토 대기율을 함께 읽는 추가 설명은
        이번 범위에서 제외했다 (design §9-J, 2026-09-13 사용자).
      */}
