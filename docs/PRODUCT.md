...
- **개발자는 1명** (나)
- **번역 편집자는 사내 비개발자 동료**
- Crowdin/Tolgee 대체가 목표가 **아니다.** 학습·실험이고, 사내에서 실제로 한 번은 써볼 수 있는
  수준이 목표다.
...
PoC에서 정한 것을 그대로 잇고, SaaS 문맥에서 새로 거절하는 것을 더한다.

**PoC에서 이어지는 것**: ICU 복수형, 동시 편집, 세밀한 RBAC, in-context 편집, 스크린샷 첨부,
