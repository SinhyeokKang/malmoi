...
| [sec-audit-2](./sec-audit-2/) | 보안 수정·로컬 검증, 배포 전 | ARCHITECTURE §9 · SAAS §11 · [작업 기록](./sec-audit-2/tasks.md) | 마이그레이션·OWNER 재연결·실물 검증, 정책 #37·#38 별도 |
| [credential-storage](./credential-storage/) | 스펙·설계 확정, 별도 워크트리 구현 초안 | [spec](./credential-storage/spec.md) · [design](./credential-storage/design.md) | sec-audit-2의 origin/dev 반영 뒤 구현 재개 |
