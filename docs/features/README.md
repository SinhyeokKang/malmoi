...
| [translation-ui](./translation-ui/) | 🚧 **진행 중** (SaaS **6a 닫힘** — ship 1~4 프로덕션 `46df51a`/#12 · `add099a`/#14 · `ef9da44`/#15 · `695e441`/#16. **6b-1** 2026-09-08 · **6b-2** `a00d380` · **6b-3**·**6b-4**·**6b-5** dev 2026-09-09) | **SAAS.md §8 6단계 · §7.7(IA 정본)** · DESIGN §3.1·§6.4·§6.5·§6.6·§6.65·§6.66·§6.67·§6.8·§7 · ARCHITECTURE §1.35·§3·§5.5·§5.5.16·§6.1·§6.3·§6.35·§6.4 · CLAUDE.md(`messages/`·`lib/i18n`·`lib/routes`·`lib/shell`·`components/shell`·`components/ui`·`middleware.ts`) · POSTMORTEM 7건(2026-09-08 4 · 2026-09-09 3) | **6b 하나만**(6b-6 Home 착지점. 6b-1~6b-5는 닫혔다. ⚠️ **번호 = 실행 순서**). ⚠️ **6b-6 착수 시 `saveTranslation`의 무효화 범위를 함께 넓힌다** — Home이 같은 행을 읽는다(POSTMORTEM 2026-09-09가 그 자리를 이름으로 적어 뒀다). `user-stories.md`는 완료돼도 남긴다(DESIGN이 참조한다). ⚠️ `tasks.md`도 남긴다 — 체크리스트 밖에 **ship 3 재측정 기록**(LCP 3.30/4.66/3.29초)이 있고 CLAUDE.md·SAAS.md·이 파일이 그것을 참조한다 |
