...
기능이 끝나면 결론은 위 두 문서로 올라가고 여기는 근거로 남는다.
...
| [tenant-auth](./tenant-auth/) | ✅ 완료 (2026-09-06, 프로덕션 반영까지) | **SAAS.md §8 2단계** · ARCHITECTURE §6·§6.1·§6.2·§6.3 · CLAUDE.md(차단 두 층·세션) | 없음 · `tasks.md` **남긴다**(§6.1이 실물 검증 기록이다) |
