...
| 자격증명 전환 | `pnpm credentials:dev` / `credentials:prod` (+ `:finalize`) — 기본 check-only. 절차는 [운영 문서](./docs/features/credential-storage/operations.md) |
